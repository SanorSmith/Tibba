-- Performance Optimization Indexes (Final Fixed Version)
...
-- Leave type filtering (using leave_type_id)
...
-- Status filtering (using payment_status)
...
-- Employment status (using employment_status)
...
-- Position filtering (fixed: job_title instead of position)
...
BEGIN
  ...
  RAISE NOTICE 'Fixed column names: leave_type_id, payment_status, employment_status, job_title';
END $$;
