-- RUN THIS TO POPULATE YOUR DATABASE WITH MOCK DATA
...
-- 3. INSERT MOCK PAYROLL TRANSACTIONS
...
-- 5. VERIFICATION - Check what was inserted
...
SELECT '=== PAYROLL INSERTED ===' as info;
...
SELECT '=== DEPARTMENTS INSERTED ===' as info;
SELECT departmentid, name, active FROM departments ORDER BY departmentid;

SELECT '=== COMPLETION ===' as info;
SELECT 'Mock data successfully inserted into database tables' as message;
