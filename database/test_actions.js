...
async function testActions() {
  try {
    console.log('🧪 Testing Attendance Exceptions Actions...\n');
    ...
    const justifyResult = await pool.query(`
      ...
      SET 
        ...
        justified_by = '00000000-0000-0000-0000-0000000000001',
    ...
    const warningResult = await pool.query(`
      ...
      SET 
        ...
        warning_issued_by = '00000000-0000-0000-0000-0000000000001',
    ...
    const dismissResult = await pool.query(`
      ...
      SET 
        ...
        dismissed_by = '00000000-0000-0000-0000-0000000000001',
    ...
    console.log(`   Final Status: ${final.review_status}`);
    console.log(`   Justification: ${final.justification || 'None'}`);
    console.log(`   Warning Issued: ${final.warning_issued ? 'Yes' : 'No'}`);
    console.log(`   Dismissed: ${final.dismissed_by ? 'Yes' : 'No'}`);
    
    // Test 5: Reset to PENDING for further testing
