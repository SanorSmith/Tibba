-- ============================================================
-- Safe Fix for Service Share Payments System
-- Run this SQL in Supabase SQL Editor
-- ============================================================

-- STEP 1: Find and drop ALL foreign key constraints on invoice_items
DO $$
DECLARE
...
-- STEP 7: Recreate foreign key constraint with VARCHAR types (only if service_id column exists)
DO $$
BEGIN
  IF EXISTS (
    SELECT 1 FROM information_schema.columns 
