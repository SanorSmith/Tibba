/**
 * Clean HR Demo Data Script (CommonJS Version)
 * Removes all demo data from HR models and leaves only 1 demo record per table
 */

const postgres = require('postgres');

// Database configuration - use the same as your existing connections
const databaseUrl = process.env.DATABASE_URL || 
                   process.env.TIBBNA_DATABASE_URL ||
                   'postgresql://neondb_owner:npg_3H8QIq1yF8rj@ep-spring-dream-a8k5g2d0-pooler.eastus2.azure.neon.tech/neondb?sslmode=require';
