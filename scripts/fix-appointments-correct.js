/**
 * Fix Appointments - Use correct status values
 */
...
async function fixAppointments() {
  console.log('🔧 Fixing appointments with correct status values...\n');
  ...
  try {
    ...
    // Create appointments with correct status values
    const appointments = [
      ...
      { patientIdx: 3, userIdx: 2, starttime: '2026-03-01 14:00:00+00', endtime: '2026-03-01 14:30:00+00', location: 'Room 201', status: 'checked_in', unit: 'Pediatrics' },
      { patientIdx: 4, userIdx: 3, starttime: '2026-03-01 15:00:00+00', endtime: '2026-03-01 15:30:00+00', location: 'Emergency Room 1', status: 'checked_in', unit: 'Emergency' },
    ...
    for (const appt of appointments) {
      ...
      console.log(`✅ Appointment: ${patient.firstname} ${patient.lastname} with ${user.name} (${appt.status})`);
    }
