    ...
    <div style={{ padding: '24px', maxWidth: '1400px', margin: '0 auto', marginTop: '8px' }}>
      ...
      <div style={{display:"flex",gap:4,marginBottom:16,background:"#f9fafb",flexWrap:"wrap",borderRadius:8,padding:4,marginTop:16,alignItems:"center"}}>
        ...
        >
          ...
          <Link href={`/d/${workspaceid}/pharmacy-inventory/procurement/claims`} style={{display:"block",padding:"8px 12px",fontSize:13,color:"#374151",textDecoration:"none",borderRadius:4,cursor:"pointer",background:"#f3f4f6"}} onClick={()=>setProcurementOpen(false)}>Claims</Link>
        ...
        {/* Action Buttons */}
        <button onClick={fetchClaims} style={{padding:"8px 16px",fontSize:13,fontWeight:600,border:"1px solid #e5e7eb",background:"#ffffff",cursor:"pointer",color:"#374151",borderRadius:6,margin:"4px 2px"}}>Refresh</button>
